...
<div class="col-lg-12">
    <ul id="sider-nav">
        <li class="sider-nav-header"><a href="{{ route('admin.index') }}"><h4><i class="glyphicon glyphicon-th-large push"></i>全部模块</h4></a></li>
        <li class="sider-nav-item"><a href="{{ route('admin.privilege.index') }}"><i class="glyphicon glyphicon-user push"></i>权限管理</a></li>
